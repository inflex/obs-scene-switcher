...
static void hardwareInit(void)
{
	...
	PORTB &= ~(1<<PB3); /* No pullup on PB3 - PLD20200606 */
...
static const uchar  keyReport[NUM_KEYS + 1][2] PROGMEM = {
	...
	/*  1 */    {MOD_CONTROL_RIGHT, KEY_F7},
	/*  2 */    {MOD_CONTROL_RIGHT, KEY_F8},
	/*  3 */    {MOD_CONTROL_RIGHT, KEY_F9},
	/*  4 */    {MOD_CONTROL_RIGHT, KEY_F10},
	/*  5 */    {MOD_CONTROL_RIGHT, KEY_F11},
	/*  6 */    {MOD_CONTROL_RIGHT, KEY_F12},
